...
router.get( '/attendance/report/:card_no/:date_str',     validate(attendanceDateSchema),   attendanceReportByDate); // [x] http://localhost:8000/auth/attendance/report/100660.1/2026-06-29
...
router.get("/location/report/summary", validate(locationReportSchema), requireHrAdmin, locationReportSummary);  // [x] http://localhost:8000/auth/location/report/summary?from_date=2026-07-01&to_date=2026-07-31&admin_card_no=100017.3
router.get( '/location/report/trail',    validate(locationReportSchema), requireHrAdmin,  locationTrail); // [x] http://localhost:8000/auth/location/report/trail?from_date=2026-07-01&to_date=2026-07-31&admin_card_no=100017.3
