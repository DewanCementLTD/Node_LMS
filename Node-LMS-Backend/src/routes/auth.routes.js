...
router.post('/attendance/:card_no',                      validate(manualAttendanceSchema), manualAttendance); // http://localhost:8000/auth/attendance/100660.1  Body: {"latitude":24.8,"longitude":67.0}
...
router.post('/apply-leave/:card_no',    validate(applyLeaveSchema), applyLeave); // http://localhost:8000/auth/apply-leave/100358.1  Body: {"leave_type_id":1,"from_date":"2026-07-05","to_date":"2026-07-06","reason":"Personal","half_day":false}


// ---------------------------------------------------------------------------
// Location  (specific routes BEFORE /:card_no wildcard)
// ---------------------------------------------------------------------------
router.post('/location/batch',           validate(locationBatchSchema),   locationBatch); // http://localhost:8000/auth/location/batch  Body: {"card_no":"100002.1","locations":[{"latitude":24.8,"longitude":67.0,"accuracy":10.0,"recorded_at":"2026-07-01T09:00:00Z"}]}
router.get("/location/report/summary", validate(locationReportSchema), requireHrAdmin, locationReportSummary); http://localhost:8000/auth/location/report/summary?from_date=2026-07-01&to_date=2026-07-31&admin_card_no=100017.3
router.get( '/location/report/trail',    validate(locationReportSchema), requireHrAdmin,  locationTrail); // http://localhost:8000/auth/location/report/trail?from_date=2026-07-01&to_date=2026-07-31&admin_card_no=100017.3
router.get( '/location/summary',         validate(locationSummarySchema), requireHrAdmin, locationSummary); // http://localhost:8000/auth/location/summary?date=2026-07-01&admin_card_no=100017.3
router.get( '/location/history/:card_no', validate(locationHistorySchema), requireHrAdmin, locationHistory); // http://localhost:8000/auth/location/history/100002.1?date=2026-07-01&admin_card_no=100002.1
